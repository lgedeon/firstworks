<?php
/*
 * Modified to add two action hooks:
 *     template_albums_jgrid_before_gallery
 *     template_albums_jgrid_after_gallery
			...
			<div id="content" class="content" role="main">
				...
				<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); // main loop ?>
					...
					<div class="full-width-wrap">
						...
						<?php do_action( 'template_albums_jgrid_before_gallery' ); ?>
						...
						<?php do_action( 'template_albums_jgrid_after_gallery' ); ?>
